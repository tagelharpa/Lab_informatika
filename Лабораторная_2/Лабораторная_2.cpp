...
int main()
{
	...
	Student t2("Акиев Вячеслав Викторович", "РИС-20-1бз", 3); // конструктор с параметрами 
	t2.show();
	cout << endl;
	...
	t3.set_FIO("Акиев Вячеслав Викторович"); // конструктор копирования 
	t3.set_group("РИС-20-1бз");
	t3.set_averageScore(3);
	cout << endl;
